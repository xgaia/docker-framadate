...
const ADRESSEMAILADMIN = '${EMAIL_ADRESS}';

// Email for automatic responses (you should set it to "no-reply")
const ADRESSEMAILREPONSEAUTO = '';

// Database server name, leave empty to use a socket
const DB_CONNECTION_STRING = 'mysql:host=${DB_HOST};dbname=${DB_NAME};port=3306';
...
$config = [
    ...
    /* home */
    'show_what_is_that' => ${SHOW_WHAT_IS_THAT},            // display "how to use" section
    'show_the_software' => ${SHOW_THE_SOFTWARE},            // display technical information about the software
    'show_cultivate_your_garden' => ${SHOW_CULTIVATE_YOUR_GARDEN},   // display "development and administration" information
    /* create_classic_poll.php / create_date_poll.php */
    'default_poll_duration' => ${DEFAULT_POLL_DURATION},         // default values for the new poll duration (number of days).
    /* create_classic_poll.php */
    'user_can_add_img_or_link' => ${USER_CAN_ADD_IMG_OR_LINK},     // user can add link or URL when creating his poll.
    'markdown_editor_by_default' => ${MARKDOWN_EDITOR_BY_DEFAULT},   // The markdown editor for the description is enabled by default
    'provide_fork_awesome' => ${PROVIDE_FORK_AWESOME},         // Whether the build-in fork-awesome should be provided
];
